...
class DemoContentSeeder extends Seeder
{
    public function run()
    {
        ...
        <h1><span class='w700'>VSPOT</span><br><span class='w200'>Digital Signage Solution</span></h1>
        <hr>
        ...
        $screen_vspot_invitation->bg_img_cdn_link = "https:
        ...
        $screen_reception_1->bg_img_cdn_link = "https:
        ...
        $screen_reception_2->bg_img_cdn_link = "https:
