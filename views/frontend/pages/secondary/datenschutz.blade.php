...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h1 class="page-heading page-heading--legal">Daten&shy;schutz</h1>
            <div class="content">
                <p class="lead">Die Nutzung unserer Seite ist ohne Angabe von personenbezogenen Daten möglich. Für
                        die Nutzung einzelner Services unserer Seite können sich hierfür abweichende Regelungen
                        ergeben, die in diesem Falle nachstehend gesondert erläutert werden. Personenbezogenen
                        Daten (z.B. Name, Anschrift, E-Mail, Telefonnummer, IP-Adresse u.ä.) werden von uns
                        ausschließlich im Rahmen der Bestimmungen des Datenschutzrechts der Bundesrepublik
                        Deutschland erhoben. Im Weiteren unterrichten wir Sie über Umfang, Art und Zweck dieser
                        Erhebung und deren Verwendung.</p>
                <h2>1. Datenschutz in der Übersicht</h2>
                ...
                <p class="px-2">Daniel Sixl<br> Krelingstraße 11<br> 90408 Nürnberg</p>
                ...
                <p>Beim Besuch von Webseiten kann Ihr Surf-Verhalten statistisch ausgewertet werden. Das geschieht
                    vor allem mit Cookies und mit sogenannten Analyseprogrammen. Sie können diesen Analysen
                    widersprechen oder sie durch die Nichtbenutzung bestimmter Tools verhindern. Über
                    Widerspruchsmöglichkeiten müssen Sie in einer Datenschutzerklärung informiert werden.<br>
                    <strong>Auf dieser Seite ist kein Analysetool von Drittanbietern (bspw. Google Analytics) in
                        Gebrauch.</strong></p>
                <h2>2. Allgemeine Hinweise und Pflicht&shy;informationen</h2>
                <h3>Datenschutz</h3>
                <p>Wir nehmen den Schutz Ihrer persönlichen Daten sehr ernst. Wir behandeln Ihre personenbezogenen
                ...
                <p>Der Nutzung von im Rahmen der Impressumspflicht veröffentlichten Kontaktdaten zur Übersendung von
                    ...
                    Wir behalten uns ausdrücklich rechtliche Schritte im Falle der unverlangten Zusendung von
                    Werbeinformationen, etwa durch Spam-E-Mails, vor.</p>
                <h2>3. Daten&shy;erfassung auf unserer Website</h2>
                <h3>Cookies</h3>
                ...
                <ul class="collection">
                    <li class="collection-item">Browsertyp und -version</li>
                    <li class="collection-item">verwendetes Betriebssystem</li>
                    <li class="collection-item">Webseite, von der aus Sie uns besuchen (Referrer URL)</li>
                    <li class="collection-item">Webseite, die Sie besuchen</li>
                    <li class="collection-item">Hostname des zugreifenden Rechners</li>
                    <li class="collection-item">Datum und Uhrzeit der Serveranfrage</li>
                    <li class="collection-item">IP-Adresse</li>
                    <li class="collection-item">Datei</li>
                    <li class="collection-item">übertragene Datenmenge</li>
                    <li class="collection-item">Meldung über erfolgreichen Abruf</li>
                    <li class="collection-item">anfragender Provider</li>
                </ul>
                ...
                <p>Mit dem Webspace-Provider wurde eine Vereinbarung zur Auftragsdatenverarbeitung, gemäß Art. 28
                    DSGVO, unterzeichnet.</p>
                <h2>4. Soziale Medien</h2>
                <p>Auf dieser Website werden aktuell keine Plugins von sozialen Netzwerken (Facebook, Twitter, o.ä.)
                    verwendet. Es besteht also keine Gefahr, dass durch Ihren Besuch auf unserer Webseite Anbieter
                    sozialer Netzwerke automatisiert Daten erheben. Es werden lediglich reguläre Verlinkungen
                    angeboten, die auf den jeweiligen Anbieter verweisen.</p>
                <h2>5. Sonstige Plugins und Tools</h2>
                <h3>Google reCAPTCHA</h3>
                <p>Wir nutzen „Google reCAPTCHA“ (im Folgenden „reCAPTCHA“) auf unseren Websites. Anbieter ist die
                    Google Inc., 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA („Google“).</p>
                <p>Mit reCAPTCHA soll überprüft werden, ob die Dateneingabe auf unseren Websites (z.B. in einem
                    ...
                    der Website oder vom Nutzer getätigte Mausbewegungen). Die bei der Analyse erfassten Daten
                ...
                <p>Die Datenverarbeitung erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der Websitebetreiber
                    hat ein berechtigtes Interesse daran, seine Webangebote vor missbräuchlicher automatisierter
                    Ausspähung und vor SPAM zu schützen.</p>
                <p>Weitere Informationen zu Google reCAPTCHA sowie die Datenschutzerklärung von Google entnehmen Sie
                    folgenden Links: <a href="https://www.google.com/intl/de/policies/privacy/">https://www.google.com/intl/de/policies/privacy/</a>
                ...
                <p>Diese Seite nutzt zur einheitlichen Darstellung von Schriftarten so genannte Web Fonts, die von
                    ...
                    in ihren Browsercache, um Texte und Schriftarten korrekt anzuzeigen.</p>
                ...
                <h2>6. Wider&shy;spruchs&shy;recht und Aus&shy;kunfts&shy;recht</h2>
                <p>Sie haben jederzeit das Recht auf unentgeltliche Auskunft über Ihre bei uns gespeicherten
                    personenbezogenen Daten, deren Herkunft und Empfänger und den Zweck der Datenverarbeitung sowie
                    ein Recht auf Berichtigung, Sperrung oder Löschung dieser Daten.</p>
                <hr class="separator">
                <p >Quellen:<br> <a href="https://www.e-recht24.de/">eRecht24</a>,<br> <a
                        href="https://www.ratgeberrecht.eu/leistungen/muster-datenschutzerklaerung.html">Anwaltskanzlei
                        Weiß &amp; Partner</a>,<br> <a href="https://www.datenschutz.org/datenschutzerklaerung/">datenschutz.org</a>,<br><a
                        href="https://datenschutz-generator.de/" rel="nofollow noopener" target="_blank"
                        style="font-size: 16px;">Datenschutz-Generator.de von RA Dr. jur. Thomas Schwenke</a></p>
            </div>
        </div>
    </div>
</div>
